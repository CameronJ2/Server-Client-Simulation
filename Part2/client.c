...
int main(){
    ...
    while (1){
        printf("What server call would you like to make? (-1 = terminate server and this client, 0 = terminate this client, 1 = establish connection with server, 2 = number of vowels, 3 = number of non-vowels, 4 = request semaphore for critical section): ");
